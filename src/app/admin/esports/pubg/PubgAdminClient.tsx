...
interface FormState {
  ...
  media: MediaItem[];          // combined images + videos in order
  featured: boolean; active: boolean;
}
...
export default function PubgAdminClient({ packages: init }: { packages: PkgItem[] }) {
  ...
  function openEdit(p: PkgItem) {
    setEditId(p.id);
    // rebuild combined media list from images[] — detect type by URL extension
            ...
            >
              ...
              <div style={{ padding:'1.5rem' }}>
                ...
                <div style={{ display:'flex', gap:10, marginBottom:'1rem', flexWrap:'wrap' }}>
                  ...
                  <button className="pa-upload-btn pa-btn" onClick={() => vidRef.current?.click()} disabled={uploading==='vid'}>
