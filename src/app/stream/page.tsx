...
const PACKAGES: StreamPkg[] = [
  { id:'watan',   name:'Watan Stream Pack',  nameAr:'باكدج وطن',     cover:'/photo/venom-1.png',  images:['/photo/venom-1.png','/photo/venom-2.png','/photo/venom-3.png','/photo/venom-4.png'] },
  { id:'venom',   name:'Venom Pack',         nameAr:'باكدج فينوم',   cover:'/photo/venom-1.png',  images:['/photo/venom-1.png','/photo/venom-2.png','/photo/venom-3.png','/photo/venom-4.png','/photo/venom-5.png','/photo/venom-6.png','/photo/venom-7.png','/photo/venom-8.png','/photo/venom-9.png','/photo/venom-10.png','/photo/venom-11.png','/photo/venom-12.png'] },
  { id:'shroud',  name:'ABN Shroud Pack',    nameAr:'باكدج شراود',   cover:'/photo/venom-5.png',  images:['/photo/venom-5.png','/photo/venom-6.png','/photo/venom-7.png'] },
  { id:'anime',   name:'Anime Pack',         nameAr:'باكدج أنمي',    cover:'/photo/venom-7.png',  images:['/photo/venom-7.png','/photo/venom-8.png'] },
  { id:'pro3d',   name:'3D Pro Pack',        nameAr:'باكدج ثري دي',  cover:'/photo/venom-9.png',  images:['/photo/venom-9.png','/photo/venom-10.png'] },
  { id:'minimal', name:'Minimal Pack',       nameAr:'باكدج مينيمال', cover:'/photo/venom-3.png',  images:['/photo/venom-3.png','/photo/venom-4.png'] },
];
...
export default function StreamPage() {
  ...
  return (
    <div dir="rtl" className="sp">
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Orbitron:wght@600;700;800&family=Cairo:wght@400;500;600;700;800&display=swap');
        ...
        *,*::before,*::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .sp {
          ...
          color:#d0cce8; font-family:'Cairo',sans-serif;
        }
        ...
        .sp-hero-content h2 {
          font-family:'Cairo',sans-serif; font-size:clamp(1.9rem,3.5vw,2.7rem);
        ...
        .sp-hero-content p {
          font-family:'Cairo',sans-serif; color:rgba(185,175,215,.5);
          font-size:.95rem; margin-bottom:28px; line-height:1.85;
        }
        .sp-hero-divider {
          width:40px; height:2px; border-radius:2px;
          background:linear-gradient(90deg,#5416B5,rgba(84,22,181,0));
          margin-bottom:24px;
        }
        .sp-hero-cta {
          ...
          box-shadow:0 6px 24px rgba(84,22,181,.4);
          transition:all .3s ease;
        }
        .sp-hero-cta:hover {
          transform:translateY(-3px);
          box-shadow:0 10px 32px rgba(84,22,181,.55);
        }
        ...
        .sp-ticker-track {
          ...
          animation:spTick 32s linear infinite;
        }
        ...
        .sp-nav-btn {
          ...
          color:rgba(175,165,208,0.5); font-family:'Cairo'; font-size:.95rem; font-weight:700;
        ...
        .sp-nav-btn:hover {
          ...
          color:#e2dcff; transform:translateY(-5px);
        ...
        /* ── Section Head ── */
        .sp-head {
          text-align:center; padding:40px 16px 36px; position:relative;
        }
        .sp-head-tag {
          ...
          border:1px solid rgba(155,89,208,0.18); background:rgba(84,22,181,0.06);
          margin-bottom:18px;
        }
        .sp-head h2 {
          font-family:'Cairo'; font-size:clamp(1.6rem,3.5vw,2.4rem);
          color:#eae6ff; font-weight:900; letter-spacing:.5px; margin-bottom:10px; line-height:1.3;
        }
        .sp-head h2 span { color:#9B59D0; }
        .sp-head p {
          font-size:.9rem; color:rgba(170,160,205,0.38);
        ...
        .sp-card:hover .sp-card-grad {
          background:linear-gradient(to top,
            rgba(4,1,14,0.98) 0%, rgba(14,5,40,0.7) 45%,
            rgba(84,22,181,0.08) 70%, transparent 100%
          );
        }
        .sp-card-body {
        ...
        .sp-card-name {
          font-family:'Cairo'; font-size:1.05rem; font-weight:700;
          color:#e8e4f8; margin-bottom:3px;
        }
        .sp-card-sub {
          color:rgba(170,155,200,0.5); font-size:.78rem; font-weight:500;
        }
        .sp-card-count {
        ...
        .sp-detail {
          ...
          animation:drawerIn .32s cubic-bezier(.25,.8,.25,1);
        ...
        .sp-back {
          ...
          color:rgba(210,200,235,0.8); font-size:.8rem;
          cursor:pointer; transition:all .2s;
        }
        .sp-back:hover { background:rgba(255,255,255,0.14); color:#fff; transform:scale(1.1); }
        .sp-detail-name {
          font-family:'Orbitron'; font-size:clamp(.78rem,2vw,1rem);
          color:#e4e0f5; font-weight:800; flex:1;
        }
        .sp-detail-cnt {
          font-size:.66rem; font-weight:700; letter-spacing:1.5px;
          color:rgba(155,89,208,0.65); white-space:nowrap;
        }
        ...
        .sp-detail-hero-overlay {
          position:absolute; inset:0;
          background:linear-gradient(to top,#0a0514 0%,rgba(10,5,20,0.25) 55%,transparent 100%);
        }
        .sp-detail-hero-content {
          position:absolute; inset:0;
          display:flex; flex-direction:column; align-items:center; justify-content:center;
        ...
        .sp-detail-hero-title {
          font-family:'Orbitron'; font-size:clamp(1.1rem,3vw,1.9rem);
          font-weight:900; color:#fff; text-align:center;
          text-shadow:0 0 40px rgba(155,89,208,0.5); letter-spacing:1px;
        }
        .sp-detail-hero-sub {
          font-size:clamp(.72rem,1.6vw,.88rem); color:rgba(200,190,225,0.55); font-weight:600;
        }
        ...
        .sp-img-sep {
          height:2px;
          background:linear-gradient(90deg,transparent,rgba(84,22,181,0.3),transparent);
        }

        /* ── Contacts panel (drawer backdrop left) ── */
        .sp-contacts-panel {
        ...
        .sp-order-label::before,.sp-order-label::after {
          content:''; width:28px; height:1px; background:rgba(155,89,208,0.3); display:block;
        }
        ...
        .sp-contact {
          ...
          background:rgba(10,4,22,0.72); border:1px solid rgba(84,22,181,0.2);
          color:#d0cce8; text-decoration:none;
          transition:all .25s cubic-bezier(.25,.8,.25,1);
          backdrop-filter:blur(16px); box-shadow:0 4px 20px rgba(0,0,0,0.3);
        }
        .sp-contact:hover {
          background:rgba(22,8,50,0.88); border-color:rgba(155,89,208,0.45);
          transform:translateY(-3px) scale(1.02); box-shadow:0 12px 36px rgba(84,22,181,0.28);
        }
        .sp-contact-icon {
        ...
        @media(max-width:768px){
          .sp-nav-row { gap:8px; }
          .sp-nav-btn { padding:22px 8px 18px; gap:10px; border-radius:16px; }
          .sp-nav-btn-icon { width:44px; height:44px; font-size:1.2rem; border-radius:13px; }
          .sp-nav-btn { font-size:.85rem; }
        ...
        @media(hover:none){
          ...
          .sp-contact:hover { transform:none; }
        }
      `}</style>
      ...
      <section className="sp-hero">
        ...
        <div className="sp-hero-content">
          ...
          <a href="#packages" className="sp-hero-cta">
            تصفح الآن <i className="fas fa-arrow-left"/>
          </a>
        </div>
      </section>
            ...
            {PACKAGES.map(pkg=>(
              <div key={pkg.id} className="sp-card" onClick={()=>setActive(pkg)}>
                ...
                <div className="sp-card-body">
                  ...
                  <div className="sp-card-sub">{pkg.name}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <>
          ...
          <div className="sp-detail">
            ...
            <div className="sp-detail-hero">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img className="sp-detail-hero-img" src={active.cover} alt={active.name}/>
